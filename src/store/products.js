...
export default {
    ...
    actions: {
        async  createProduct (context,payload) {
            try{
                await  axios.post('http://localhost:3000/api/catalog/products/create',payload)
       ...
       async  updateProductById (context,payload) {
            try{
               ...
               await axios.put(`http://localhost:3000/api/catalog/products/update/${payload.id}`,payload)
        ...
        async deleteProductById (context,payload) {
            try{
                  await axios.delete(`http://localhost:3000/api/catalog/products/delete/${payload.id}`)
